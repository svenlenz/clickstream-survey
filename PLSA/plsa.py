...
def output():
    ...
    # document-topic distribution
    file = codecs.open(clusterList,'w','utf-8')
    clusters = ["static List<Integer> cl1 = Arrays.asList(",
                "static List<Integer> cl2 = Arrays.asList(",
                "static List<Integer> cl3 = Arrays.asList(",
                "static List<Integer> cl4 = Arrays.asList(",
                "static List<Integer> cl5 = Arrays.asList("]
    for i in range(0, N):
        tmp = ''
        biggestValue = 0.0
        biggestTopic = -1
