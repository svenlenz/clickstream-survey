...
public class CompareToPrototypes {
	...
	private static int[] dch3_1 = new int[]{10, 12, 14, 15, 18, 25, 28, 30, 31, 32, 33, 34, 35, 37, 39, 42, 43, 44, 46, 49, 59, 61, 62, 63, 64, 65, 67, 68, 70, 72, 73, 74, 77, 80, 82, 85, 87, 88, 89, 90, 91, 92, 93, 99, 100, 104, 106, 107, 110, 113, 119, 121, 123, 126};
	private static int[] dch3_2 = new int[]{1, 2, 3, 4, 5, 6, 7, 17, 19, 21, 22, 23, 24, 26, 27, 29, 36, 38, 40, 41, 45, 47, 50, 53, 55, 58, 60, 66, 69, 71, 75, 76, 83, 84, 94, 96, 97, 101, 103, 108, 109, 112, 114, 115, 116, 117, 122, 124, 125};
	private static int[] dch3_3 = new int[]{8, 9, 11, 13, 16, 20, 51, 52, 54, 56, 57, 78, 79, 81, 86, 95, 98, 102, 105, 111, 118, 120};
